...
public class ioCompareActivity extends AppCompatActivity {
    ...
    private void drawSummary() {
        ...
        if (l1.vfs_r != 0 && l2.vfs_r != 0) vfss = ((float)l2.vfs_r / l1.vfs_r) * 100;
        if (l1.ext_r != 0 && l2.ext_r != 0) extt = ((float)l2.ext_r / l1.ext_r) * 100;
        if (l1.block_r != 0 && l2.block_r != 0) blockk = ((float)l2.block_r / l1.block_r) * 100;
        if (l1.driver_r != 0 && l2.driver_r != 0) driverr = ((float)l2.driver_r / l1.driver_r) * 100;

        vfs.setText( Integer.toString(l1.vfs_r - l2.vfs_r) );
        ext.setText( Integer.toString(l1.ext_r - l2.ext_r) );
        block.setText( Integer.toString(l1.block_r - l2.block_r ));
        driver.setText( Integer.toString(l1.driver_r - l2.driver_r)) ;
        ...
        if (l1.vfs_w != 0 && l2.vfs_w != 0) vfss = ((float)l2.vfs_w / l1.vfs_w) *100;
        if (l1.ext_w != 0 && l2.ext_w != 0) extt = ((float)l2.ext_w / l1.ext_w) *100;
        if (l1.block_w != 0 && l2.block_w != 0) blockk = ((float)l2.block_w / l1.block_w) *100;
        if (l1.driver_w != 0 && l2.driver_w != 0) driverr = ((float)l2.driver_w / l1.driver_w) *100;

        vfs.setText( Integer.toString(l1.vfs_w - l2.vfs_w) );
        ext.setText( Integer.toString(l1.ext_w - l2.ext_w) );
        block.setText( Integer.toString(l1.block_w - l2.block_w ));
        driver.setText( Integer.toString(l1.driver_w - l2.driver_w)) ;
